...
public class QuickSort
{
  ...
  private static void QuickSortAuxiliarIntegerAscendent(ListaSimple<Integer> list, int left, int last)
  {
    ...
    int j = last;
    do {
      while (((Integer)list.get(i)).intValue() < pivot) i++;
      while (((Integer)list.get(j)).intValue() > pivot) j--;
      if (i <= j) {
        list.swap(i, j);
        i++;
        j--;
      ...
      i <= j);
    if (left < j) QuickSortAuxiliarIntegerAscendent(list, left, j);
    if (i < last) { QuickSortAuxiliarIntegerAscendent(list, i, last);
    }
  }
  ...
  private static void QuickSortAuxiliarIntegerDescendant(ListaSimple<Integer> list, int left, int last)
  {
    ...
    do {
      ...
      i <= j);
    if (left < j) QuickSortAuxiliarIntegerDescendant(list, left, j);
    if (i < last) { QuickSortAuxiliarIntegerDescendant(list, i, last);
    }
  }
  ...
  private static void QuickSortAuxiliarStringAscendant(ListaSimple<String> list, int left, int last)
  {
    ...
    int j = last;
    do {
      while (((String)list.get(i)).compareTo(pivot) < 0) i++;
      while (((String)list.get(j)).compareTo(pivot) > 0) j--;
      if (i <= j) {
        list.swap(i, j);
        i++;
        j--;
      ...
      i <= j);
    if (left < j) QuickSortAuxiliarStringAscendant(list, left, j);
    if (i < last) { QuickSortAuxiliarStringAscendant(list, i, last);
    }
  }
  ...
  private static void QuickSortAuxiliarComparableAscendant(ListaSimple<Comparable> list, int left, int last)
  {
    ...
    int j = last;
    do {
      while (((Comparable)list.get(i)).compareTo(pivot) < 0) i++;
      while (((Comparable)list.get(j)).compareTo(pivot) > 0) j--;
      if (i <= j) {
        list.swap(i, j);
        i++;
        j--;
      ...
      i <= j);
    if (left < j) QuickSortAuxiliarComparableAscendant(list, left, j);
    if (i < last) { QuickSortAuxiliarComparableAscendant(list, i, last);
    }
  }
  ...
  private static void QuickSortAuxiliarComparableDescendant(ListaSimple<Comparable> list, int left, int last)
  {
    ...
    do {
      ...
      i <= j);
    if (left < j) QuickSortAuxiliarComparableDescendant(list, left, j);
    if (i < last) QuickSortAuxiliarComparableDescendant(list, i, last);
  }
}