...
public class RadixSort
{
  ...
  private static Odyssey.Estructuras.Listas.NodeLista<String> RadixSortAuxiliarString(ListaSimple<String> list, int larger, int mod)
  {
    if (mod <= larger) {
  ...
  private static Odyssey.Estructuras.Listas.NodeLista<Comparable> RadixSortAuxiliarComparable(ListaSimple<String> stringList, ListaSimple<Comparable> comparableList, int larger, int mod)
  {
    if (mod <= larger) {
      int[] counter = new int['A'];
  ...
  private static Odyssey.Estructuras.Listas.NodeLista<Integer> RadixSortAuxiliarInteger(ListaSimple<Integer> list, int larger, int mod)
  {
    if (mod <= larger) {
